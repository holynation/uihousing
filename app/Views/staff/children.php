  ...
  <div class="row">
    ...
    <div class="card d-flex">
        <div class="my-2 d-grid justify-content-end">
            <a href="#" class="btn btn-primary" data-bs-toggle='modal' data-bs-target='#myModal'><em class="menu-icon tf-icons bx bx-plus-medical"></em><span>Register Children</span>
            </a>
        </div>
    </div>
    <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-top" role="document">
        <div class="modal-content">
            <div class="modal-header">
                  <h5 class="modal-title">Children Form</h5>
                  <button
                    type="button"
                    class="btn-close"
            ...
            <div class="modal-body">
              <?php
                  ...
                  $formContent = $modelFormBuilder->start('children_table')
                  ->appendInsertForm('children',true,$hidden,'',$showStatus,$exclude)
                  ->addSubmitLink(null)
