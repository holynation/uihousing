...
* And it represent the model of the staff_old table
*/
class Staff_old extends Crud {

/** 
* This is the entity name equivalent to the table name
* @var string
*/
protected static $tablename = "Staff_old"; 

/** 
* This array contains the field that can be null
* @var array
*/
public static $nullArray = ['othername','staff_path'];
...
* @var array
*/
public static $uniqueArray = ['occupant_num'];
...
* @var array
*/
public static $typeArray = ['occupant_num' => 'varchar','surname' => 'varchar','firstname' => 'varchar','othername' => 'varchar','gender' => 'enum','dob' => 'date','marital_status' => 'enum','num_children' => 'int','lga_of_state' => 'int','title_id' => 'int','academic_status' => 'enum','staff_grade' => 'int','designation_id' => 'int','date_first_appointment' => 'date','date_present_appointment' => 'date','date_of_confirm' => 'date','office_address' => 'varchar','phone_number' => 'varchar','hall' => 'enum','staff_path' => 'varchar','status' => 'tinyint','date_modified' => 'timestamp','date_created' => 'timestamp'];
...
* @var array
*/
public static $labelArray = ['ID' => '','occupant_num' => '','surname' => '','firstname' => '','othername' => '','gender' => '','dob' => '','marital_status' => '','num_children' => '','lga_of_state' => '','title_id' => '','academic_status' => '','staff_grade' => '','designation_id' => '','date_first_appointment' => '','date_present_appointment' => '','date_of_confirm' => '','office_address' => '','phone_number' => '','hall' => '','staff_path' => '','status' => '','date_modified' => '','date_created' => ''];

/** 
* Associative array of fields in the table that have default value
* @var array
*/
public static $defaultArray = ['gender' => 'male','marital_status' => 'married','academic_status' => 'others','date_first_appointment' => '1111-01-01','hall' => 'off_campus','status' => '0','date_modified' => 'current_timestamp()','date_created' => 'current_timestamp()'];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/staff_old', 'edit' => 'edit/staff_old'];
...
public function getStaff_gradeFormField($value = ''){
	return "<div class='form-group'>
				<label for='staff_grade'>Staff Grade</label>
				<input type='text' name='staff_grade' id='staff_grade' value='$value' class='form-control' required />
			</div>";
} 
...
public function getDate_first_appointmentFormField($value = ''){
	return "<div class='form-group'>
				<label for='date_first_appointment'>Date First Appointment</label>
				<input type='text' name='date_first_appointment' id='date_first_appointment' value='$value' class='form-control' required />
			</div>";
} 
public function getDate_present_appointmentFormField($value = ''){
	return "<div class='form-group'>
				<label for='date_present_appointment'>Date Present Appointment</label>
				<input type='text' name='date_present_appointment' id='date_present_appointment' value='$value' class='form-control' required />
			</div>";
} 
public function getDate_of_confirmFormField($value = ''){
	return "<div class='form-group'>
				<label for='date_of_confirm'>Date Of Confirm</label>
				<input type='text' name='date_of_confirm' id='date_of_confirm' value='$value' class='form-control' required />
			</div>";
} 
