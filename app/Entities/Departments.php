...
* And it represent the model of the departments table
*/
...
* @var array
*/
public static $typeArray = ['name' => 'varchar'];
...
* @var array
*/
public static $labelArray = ['ID' => '','name' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/departments', 'edit' => 'edit/departments'];
