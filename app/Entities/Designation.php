...
* And it represent the model of the designation table
*/
class Designation extends Crud {

/** 
* This is the entity name equivalent to the table name
* @var string
*/
protected static $tablename = "Designation"; 
...
* @var array|string
*/
public static $displayField = 'designation_name';

/** 
* This array contains the fields that are unique
* @var array
*/
public static $uniqueArray = ['designation_name'];
...
* @var array
*/
public static $typeArray = ['designation_name' => 'varchar','status' => 'tinyint'];
...
* @var array
*/
public static $labelArray = ['ID' => '','designation_name' => '','status' => ''];
...
public function getDesignation_nameFormField($value = ''){
	return "<div class='form-group'>
				<label for='designation_name'>Designation Name</label>
				<input type='text' name='designation_name' id='designation_name' value='$value' class='form-control' required />
			</div>";
} 
