...
* And it represent the model of the super_agent table
*/
class Super_agent extends Crud {

/** 
* This is the entity name equivalent to the table name
* @var string
*/
protected static $tablename = "Super_agent"; 
...
* @var array|string
*/
public static $displayField = 'super_code';

/** 
* This array contains the fields that are unique
* @var array
*/
public static $uniqueArray = ['super_code','email'];
...
* @var array
*/
public static $typeArray = ['super_code' => 'varchar','fullname' => 'varchar','email' => 'varchar','phone_number' => 'varchar','address' => 'text','status' => 'tinyint','date_modified' => 'timestamp','date_created' => 'timestamp'];
...
* @var array
*/
public static $labelArray = ['ID' => '','super_code' => '','fullname' => '','email' => '','phone_number' => '','address' => '','status' => '','date_modified' => '','date_created' => ''];
...
* @var array
*/
public static $tableAction = ['delete' => 'delete/super_agent', 'edit' => 'edit/super_agent'];
...
public function getSuper_codeFormField($value = ''){
	return "<div class='form-group'>
				<label for='super_code'>Super Code</label>
				<input type='text' name='super_code' id='super_code' value='$value' class='form-control' required />
			</div>";
} 
